...
const config = {
  ...
  themeConfig:
    ...
    ({
      ...
      announcementBar: {
        id: 'support_us',
        content: '⭐️ 如果这个网站能帮助到你，欢迎给一个star支持作者  <a target="_blank" rel="noopener noreferrer" href="https://github.com/SunshinestyleCommunity/ZF_KnowledgeWarehouse">GitHub</a>',
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/SunshinestyleCommunity/ZF_KnowledgeWarehouse',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      algolia: {
        ...
        indexName: 'SunshinestyleCommunity',
      }
    }),
};
